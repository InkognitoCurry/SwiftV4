...
local Combat = GuiLibrary.CreateWindow("Combat", "⚔", UDim2.new(0, 183, 0, 6), true)
local Blatant = GuiLibrary.CreateWindow("Blatant", "⚠", UDim2.new(0, 189, 0, 6), true)
local Render = GuiLibrary.CreateWindow("Render", "👁", UDim2.new(0, 195, 0, 6), true)
local Utility = GuiLibrary.CreateWindow("Utility", "🛠", UDim2.new(0, 201, 0, 6), true)
local World = GuiLibrary.CreateWindow("World", "🌎", UDim2.new(0, 207, 0, 6), true)
local Other = GuiLibrary.CreateWindow("Other", "❔", UDim2.new(0, 213, 0, 6), true)
local Settings = GuiLibrary.CreateWindow("Settings", "⚙", UDim2.new(0, 219, 0, 6), true)
local Friends = GuiLibrary.CreateWindow("Friends", "👨‍👦", UDim2.new(0, 225, 0, 6), false)
local Search = GuiLibrary.CreateWindow("Search", "🔍", UDim2.new(0, 231, 0, 6), true)
--local TextGui = GuiLibrary.CreateCustomWindow("Text GUI", "📄", UDim2.new(0, 177, 0, 6), false)
local TextGui = GuiLibrary.CreateCustomWindow("amogus", ":)", UDim2.new(0, 237, 0, 6), true)
