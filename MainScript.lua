...
local Combat = GuiLibrary.CreateWindow("Combat", "⚔", UDim2.new(0, 20, 0, 6), true)
local Blatant = GuiLibrary.CreateWindow("Blatant", "⚠", UDim2.new(0, 40, 0, 6), true)
local Render = GuiLibrary.CreateWindow("Render", "👁", UDim2.new(0, 60, 0, 6), true)
local Utility = GuiLibrary.CreateWindow("Utility", "🛠", UDim2.new(0, 80, 0, 6), true)
local World = GuiLibrary.CreateWindow("World", "🌎", UDim2.new(0, 100, 0, 6), true)
local Other = GuiLibrary.CreateWindow("Other", "❔", UDim2.new(0, 120, 0, 6), true)
local Settings = GuiLibrary.CreateWindow("Settings", "⚙", UDim2.new(0, 140, 0, 6), true)
local Friends = GuiLibrary.CreateWindow("Friends", "👨‍👦", UDim2.new(0, 160, 0, 6), false)
local Search = GuiLibrary.CreateWindow("Search", "🔍", UDim2.new(0, 180, 0, 6), true)
--local TextGui = GuiLibrary.CreateCustomWindow("Text GUI", "📄", UDim2.new(0, 177, 0, 6), false)
local TextGui = GuiLibrary.CreateCustomWindow("amogus", ":)", UDim2.new(0, 200, 0, 6), true)
