...
local Combat = GuiLibrary.CreateWindow("Combat", "⚔", UDim2.new(0, 203, 0, 6), true)
local Blatant = GuiLibrary.CreateWindow("Blatant", "⚠", UDim2.new(0, 223, 0, 6), true)
local Render = GuiLibrary.CreateWindow("Render", "👁", UDim2.new(0, 243, 0, 6), true)
local Utility = GuiLibrary.CreateWindow("Utility", "🛠", UDim2.new(0, 263, 0, 6), true)
local World = GuiLibrary.CreateWindow("World", "🌎", UDim2.new(0, 283, 0, 6), true)
local Other = GuiLibrary.CreateWindow("Other", "❔", UDim2.new(0, 303, 0, 6), true)
local Settings = GuiLibrary.CreateWindow("Settings", "⚙", UDim2.new(0, 323, 0, 6), true)
local Friends = GuiLibrary.CreateWindow("Friends", "👨‍👦", UDim2.new(0, 343, 0, 6), false)
local Search = GuiLibrary.CreateWindow("Search", "🔍", UDim2.new(0, 363, 0, 6), true)
--local TextGui = GuiLibrary.CreateCustomWindow("Text GUI", "📄", UDim2.new(0, 177, 0, 6), false)
local TextGui = GuiLibrary.CreateCustomWindow("amogus", ":)", UDim2.new(0, 383, 0, 6), true)
